        ...
        <div className="flex gap-3">
          {authService.hasAdminRole() && (
            <button
              ...
              className="flex-1 py-2.5 px-4 border border-gray-300 dark:border-zinc-800 bg-transparent hover:bg-gray-100 dark:hover:bg-zinc-800/80 text-gray-700 dark:text-zinc-300 font-medium rounded-lg transition-colors cursor-pointer disabled:opacity-50 text-sm text-center"
            >
              Back to Dashboard
            </button>
          )}
